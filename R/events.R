...
#' nMjLX(-2500)
nMjLX = function(year = cur.year, parallax = .85) {
  return(obliquity(year) + 5.145 - parallax)
}
...
#' sMjLX(-2500)
sMjLX = function(year = cur.year, parallax = .85) {
  return(-(obliquity(year) + 5.145) - parallax)
}
